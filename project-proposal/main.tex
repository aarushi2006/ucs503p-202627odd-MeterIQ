...
\begin{itemize}[leftmargin=0.7cm]
    ...
    backend, data storage and dashboard so that the results can be
    viewed through one application.
...
\begin{enumerate}[leftmargin=0.7cm]
    ...
    \item The results are made available through the backend and data
    storage layer.
...
\begin{itemize}[leftmargin=0.7cm]
    ...
    \item The frontend, backend, data storage and ML parts should be
    kept separate enough that they can be developed and tested
    independently.
\end{itemize}
...
the ML components, and then connect them to the backend, data storage
and frontend.
...
\begin{itemize}[leftmargin=0.7cm]
    \item \textbf{Frontend:} A web-based interface will be developed
    to display consumption, anomaly and forecasting results.

    \item \textbf{Backend API:} A backend layer will connect the
    frontend with the data processing and machine learning
    components.
    ...
    \item \textbf{Database:} A suitable database will be used to
    store meter information, processed results and application data.
...
The data storage and application layers will remain separate from
the model code, making it possible to update or retrain models as
...
\begin{itemize}[leftmargin=0.7cm]
    ...
    application.
    \item A suitable data storage layer for meter, anomaly and
...
\begin{itemize}[leftmargin=0.7cm]
    ...
    \item \textbf{System integration:} the frontend, backend, data
    storage and ML components will be developed as separate modules
    and tested before final integration.
\end{itemize}
...
models, data storage, backend APIs and web dashboard into one
