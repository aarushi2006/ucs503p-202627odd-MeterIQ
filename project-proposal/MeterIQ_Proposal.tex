...
\newcommand{\Bvr@LabInstructor}{Mr.Jeelani}
...
\BvrSetLabInstructor{Mr. Jeelani}
...
\author{
  Yashit Arora, CSED\textsuperscript{*}
  \and
  Aarushi Gahlawat, CSED\textsuperscript{*}
}

\date{
  \small
  \textsuperscript{*}Roll No: 1024160006, Email: \texttt{yarora1\_be24@thapar.edu}\\
  \textsuperscript{*}Roll No: 1024160008, Email: \texttt{agahlawat\_be24@thapar.edu}\\[0.5em]
  \today
}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{Use Case Diagram.drawio (1).png}
    \caption{Use Case Diagram of Smart Meter Analysis and Theft Detection System}
    \label{fig:use-case-diagram}
\end{figure}

\subsection{Data Flow Diagram}

The Level-0 Data Flow Diagram (DFD) illustrates the overall flow of data
between the Smart-Meter Data Source, the MeterIQ System, and the user.
It provides a high-level representation of how meter data enters the system,
how the system processes it, and how the results and user requests flow
between the system and the distribution personnel.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{dfd_level0.png}
    \caption{Level-0 Data Flow Diagram of the MeterIQ System}
